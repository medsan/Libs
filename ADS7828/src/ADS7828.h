...
private:
  ...
  // static SemaphoreHandle_t ESP32_i2cMutex; // Usando um semáforo de mutex
  // inline static SemaphoreHandle_t i2cSemaphore  = xSemaphoreCreateMutex(); // Usando um semáforo de mutex
};
